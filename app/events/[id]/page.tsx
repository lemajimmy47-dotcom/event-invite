      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl border p-4 text-center">
            <p className="text-2xl font-bold text-blue-600">{guestList.length}</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200">
          <div className="flex items-center justify-between p-6 border-b border-gray-100">
            ...
            <Link href={"/events/" + id + "/guests/new"} className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition">
              + Ongeza Wageni
            </Link>
          </div>
          ...
          {guestList.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-400">Hakuna wageni bado</p>
            </div>
          ) : (
